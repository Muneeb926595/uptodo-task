class _Images {
  ...
  readonly WelcomeCarousel1 = require('../assets/images/WelcomeCarousel1.webp');
  readonly WelcomeCarousel2 = require('../assets/images/WelcomeCarousel2.webp');
  readonly WelcomeCarousel3 = require('../assets/images/WelcomeCarousel3.webp');
}
